...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer REPLACE_WITH_KEY' http://a590586a-feb8-4984-939b-654af733c5aa.eastus2.azurecontainer.io/score
